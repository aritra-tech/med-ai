          ...
          <div className="text-center p-4 bg-white/5 border border-white/10 rounded-2xl">
            <div className="relative max-w-xs mx-auto mb-6">
              <img 
                ...
                className="rounded-2xl shadow-2xl border border-gray-800"
              />
              <div className="absolute -inset-2 bg-gradient-to-r from-green-500/20 to-blue-500/20 rounded-2xl blur-xl animate-pulse animation-delay-2000"></div>
            </div>
          ...
          <div className="text-center p-4 bg-white/5 border border-white/10 rounded-2xl">
            <div className="relative max-w-xs mx-auto mb-6">
              <img 
                ...
                className="rounded-2xl shadow-2xl border border-gray-800"
              />
              <div className="absolute -inset-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-2xl blur-xl animate-pulse animation-delay-4000"></div>
            </div>
