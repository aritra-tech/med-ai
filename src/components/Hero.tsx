...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-black text-white overflow-hidden py-20 lg:py-0">
      {/* Background Glows */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="text-center lg:text-left">
            <div className="mb-8">
              ...
              <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto lg:mx-0 leading-relaxed animate-fade-in-up animation-delay-200">
                AI-Powered Prescription Analysis and Management
              </p>
              <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto lg:mx-0 animate-fade-in-up animation-delay-400">
            ...
            <div className="flex justify-center lg:justify-start items-center animate-fade-in-up animation-delay-600">
          ...
          <div className="hidden lg:flex justify-center animate-fade-in-up animation-delay-800">
